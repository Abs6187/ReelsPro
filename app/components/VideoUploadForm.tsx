  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 ">
      ...
      <div className="flex items-center justify-center mx-auto">
        <button 
          type="submit" 
          className="btn bg-blue-700 w-[140px] text-white disabled:bg-gray-500 disabled:opacity-70 disabled:cursor-not-allowed"
          disabled={(uploadProgress > 0 && uploadProgress < 100) || loading}
        >
          {loading ? (
            <>
